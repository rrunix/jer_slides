...
::: {.incremental}
1. **Protocolos de capa de aplicación**: Definen cómo las aplicaciones intercambian datos
2. **Arquitectura de aplicaciones en red**: Cliente-servidor, P2P, híbrida
3. **Sockets**: Interfaz entre capa de aplicación y capa de transporte
:::
...
| **Navegación web** | Sí | Moderada | Elástica | Sí (HTTPS) | UDP (HTTP/3) / TCP |
...
- **TCP**: Confiabilidad crítica
- **UDP**: Baja latencia prioritaria
- **QUIC**: Mejor de ambos mundos

**Identificación de procesos:**

- IP del host + Puerto
- Ejemplos: HTTP(80), HTTPS(443), DNS(53)
:::
