...
- **Three.js**: Biblioteca para gráficos 3D con WebGL - crea escenas 3D en el navegador
- **Babylon.js**: Motor 3D completo con física y efectos avanzados
- **PixiJS**: Renderizador 2D ultra rápido - ideal para sprites y animaciones

**Propósito general:**

- **Lodash**: Utilidades para trabajar con arrays, objetos y funciones de forma eficiente
- **Axios**: Cliente HTTP moderno para hacer peticiones al servidor (reemplazo de fetch)
