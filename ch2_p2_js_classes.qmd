...
## Uso de Clases - Getters

**Acceso a propiedades calculadas**
...
console.log(`Vida actual: ${goblin.vida}`);
```

- Sin paréntesis, como propiedades normales
- Transparentes para el código cliente
- Pueden ejecutar cálculos o validaciones
