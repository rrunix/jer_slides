...
**Aplicar en juego multijugador:**

1. REST para registro y autenticación
2. WebSockets para estado del juego
3. Patrón Command para acciones
4. Sincronización de estado
5. Manejo de desconexiones

::: {.callout-note}
La combinación de estas tecnologías permite juegos robustos y escalables
:::
