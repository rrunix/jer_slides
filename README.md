...
Diapositivas para la asignatura Juegos en Red (URJC).

## Contenido

- **Redes de computadores**: Introducción, capas de acceso, red, transporte y aplicación
- **Programación cliente**: JavaScript y programación orientada a objetos
- **Phaser**: Framework para desarrollo de juegos
- **Comunicación**: API REST y WebSockets

## Uso

Este proyecto utiliza Quarto para generar presentaciones con Reveal.js.

```bash
quarto render
```

Las diapositivas generadas se encuentran en el directorio `slides/`.
